    	...
    	<div class="hide" ><!-- class="hide" -->
					...
					<div class="hide" ><!-- class="hide" -->
						<table id="data-tablee">
							...
							<tbody>
								<c:forEach var="s" items="${studentcountgovtpoly2}" varStatus="count">
									<tr>
										<td>${s.rollId}</td>
										<td>${s.studentName}</td>
										<td>${s.instituteCode}</td>
        ...
        const attendanceChart = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Attendance Summary For Govt Poly-1', // Your desired title here
                        font: {
                            size: 16,
                            weight: 'bold',
                            color: 'rgba(0, 0, 0, 1)'
        ...
        const attendanceChart = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Attendance Summary For Govt Poly-2', // Your desired title here
                        font: {
                            size: 16,
                            weight: 'bold',
                            color: 'rgba(0, 0, 0, 1)'
