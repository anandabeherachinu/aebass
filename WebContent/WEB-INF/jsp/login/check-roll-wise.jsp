                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active text-align form-new" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <h3 class="register-heading">check the roll id</h3>
								...
								<div id="radioDiv" style="display: block;">
									...
									<input value="1" name="proto" type="radio"
                                        ...
                                        <div class="form-group">
                                            <form:input path="rollId" type="text" name="LGform1_user" class="form-control" placeholder="Enter Roll" value="" required="true" onchange="captureFPAuth()"/>
                                        </div>
