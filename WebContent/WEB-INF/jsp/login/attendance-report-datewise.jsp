...
<%--   <div class="panel-heading">
 			...
 			<div class="box col-md-12">
 				...
 				<form:form class="form-horizontal " action="attendance-report-datewise.html" method="post"  modelAttribute="cb">
				...
				<table class="table_form">
 					...
 					<tr>
						...
						<td>
							 <form:select path="instituteCode" class="courese-sector readonly-select" required="true" id="institutecodeajax" readonly="true" >
