...
%>
    ...
    <%
        ...
        try {
            ...
            out.println("<p>Unexpected error occurred: " + e.getMessage() + "</p>");
        }
    %>
...
<%--   <div class="panel-heading">
 			...
 			<div class="box col-md-12">
 				...
 				<form:form class="form-horizontal " action="attendance-report-datewise-iti.html" method="post"  modelAttribute="cb">
				...
				<table class="table_form">
 					...
 					<tr>
						...
						<td>
							 <form:select path="instituteCode" class="courese-sector readonly-select" required="true" id="AA" readonly="true" >
					      			<form:option value="">Select</form:option>
					      			<c:forEach var="s"  items="${listOfCollege}">
 			...
 			<%-- 		<tr>
						...
						<td>
												 <form:select path="semestar" class="courese-sector" required="true" id="semesterAjax">
				      		</form:select>
							 <form:select path="semestar" class="courese-sector" required="true" id="semesterAjax">
					      			<form:option value="">Select</form:option>
					...
					<td id="secetor-text">Date:<span class="required-star" >*</span></td>
							<td><form:input path="dob"  class="courese-sector" id="dob" placeholder="yyyy-mm-dd" required="true" />
									</td>
 			...
 			<c:when test="${sessionScope.role_id eq '1'}">
				...
				<%-- <h5>Institute Name:${instituteName} </h5>
 				<h5>Semester:${semestar} </h5> --%>
 				 	...
 				 	<h5>Institute Code :${selectedInstitute} </h5>
...
<script type="text/javascript" src="js/pia-tc-sec-cor-batch.js"></script>
...
<script type="text/javascript" src="js/jquery.validate.min.js"></script>
 ...
 <!--  <link rel="stylesheet" type="text/css"
	...
	<%String sectorCode=(String)request.getAttribute("sector");
		//System.out.println("sectorCode===="+sectorCode); 
		
		//String subsectorCode=(String)request.getAttribute("subsector");
		//System.out.println("subsectorCode===="+subsectorCode);  %>
	...
	$(document).ready(function() 
	{
	    ...
	    <script src="admin-public/js/datatable/jquery.dataTables.min.js"></script>
		<script src="admin-public/js/datatable/dataTables.bootstrap.min.js"></script>
		 <script type="text/javascript" src="js/sector_subsector.js"></script> 
...
<body>
 ...
 <c:choose>
  ...
  <div class="panel-heading">
 			...
 			<form:form class="form-horizontal" action="attendance-report-datewise-iti.html" method="post" modelAttribute="cb" 
 			autocomplete="off" id="trainingCommencement">
 			
			<table class="table_form">
 					<tr> 
 						<th colspan="2">Training Commencement Report</th>
 					</tr>
 					<tr>
						<td><label id="secetor-text"> PIA Name:<span class="required-star">*</span></label></td>
						<td>
							 <form:select path="instituteCode" class="text-field" required="true" id="institutecodeajax">
					      			<form:option value="">Select</form:option>
					      			<c:forEach var="s"  items="${listOfCollege}">
					      				<form:option  value="${s.instituteCode}">${s.instituteCode}/${s.instituteName}</form:option>		
					      			</c:forEach>
 	...
 	<c:forEach var="view" items="${piaList}">
		<div class="row-fluid" id="deptpaging_cand">
			<div class="box span12">
<table class="table_display" >
					
					
							<tr>
								<th colspan="4" style="text-align: left;">Training Commencement Report</th>

							</tr>
</table>
				<div class="box-content" id="deptpaging_print" >
...
<script>
 ...
 function isNumber(evt) {
   	 ...
   	 <!-- <script type="text/javascript" src="js/sector_subsector.js"></script> -->
   	  <script type="text/javascript" src="js/pia-tc-sec-cor-batch.js"></script>  
   	<!--  <script type="text/javascript" src="js/pia-tc-sec-cor-batch-login-pia.js"></script>  -->
...
<script>
    var myApp = new function () {
        this.printTable = function () {
            var tab = document.getElementById('deptpaging_print');
            var win = window.open('', '', 'height=700,width=700');
            win.document.write(tab.outerHTML);
            win.document.close();
            win.print();
