 ...
 --%>              
 		<form:form class="form-horizontal" enctype="multipart/form-data"
						...
						<div class="panel-body">
								...
								<div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Student Name<span class="text-danger"> *</span></label> <form:input path= "studentName" type="text"  name="fname"  id="student_name" value="${studentName}" readonly="true" onblur="validate(1)"/> </div>
					
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Father Name<span class="text-danger"> *</span></label> <form:input path= "fathername" type="text" id="lname" name="lname"  value="${fatherName}" readonly="true"  onblur="validate(2)"/> </div>
                    </div>
                    
                    
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Redg Number<span class="text-danger"> *</span></label> <form:input path= "rollId" type="text" placeholder="" value="${registrationNumber}"  readonly="true"  onblur="validate(3)"/> </div>
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Mobile Number<span class="text-danger"> *</span></label> <form:input path= "mobileNumber" type="text"  placeholder="" onblur="validate(4)" value="${mobileNumber}" readonly="true" /> </div>
                    </div>
                   <%--   <div class="row justify-content-between text-left">
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Institute Name<span class="text-danger"> *</span></label> 
                        <form:input path= "instituteName" type="text" placeholder="" value="${instituteName}"  readonly="true"  onblur="validate(3)"/> </div>
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Gender<span class="text-danger"> *</span></label> 
                        <form:input path= "gender" type="text"  placeholder="" onblur="validate(4)" value="${mobileNumber}" readonly="true" /> </div>
                    </div> --%>
                     <div class="row justify-content-between text-left">
                      <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Institute Name<span class="text-danger"> *</span></label> 
                        <form:input path= "instituteName" type="text" value="${instituteName}" readonly="true"  /> </div>
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Gender<span class="text-danger"> *</span></label> 
                        <form:input path= "gender" type="text"  placeholder="" onblur="validate(4)" value="${gender}" readonly="true" /> </div>
                    </div>
                      <div class="row justify-content-between text-left">
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">D.O.B<span class="text-danger"> *</span></label> <form:input path= "dob" type="text" value="${outputDate}" placeholder="" onblur="validate(3)" readonly="true" /> </div>
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Semester<span class="text-danger"> *</span></label> <form:input path= "semestar" type="text"  placeholder="" onblur="validate(4)" value="${semester}" readonly="true" /> </div>
                    </div>
                   
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Email<span class="text-danger"> *</span></label> 
                        <form:input path= "email" type="email" value="${emailId}" readonly="true"  /> </div>
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Academic-Year<span class="text-danger"> *</span></label> 
                        <form:input path= "academicYear" type="text" value="${academicYear}" readonly="true"  /> </div>
                    </div>
                     <div class="hide">
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Mother Name<span class="text-danger"> *</span></label> 
                        <form:input path= "mothername" type="text" value="${motherName}" readonly="true"  /> </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Institute Code<span class="text-danger"> *</span></label> <form:input path= "instituteCode" type="text"  value="${instituteCode}" placeholder="" readonly="true"  onblur="validate(3)"/> </div>

                    </div>
                    
                     <div class="hide">
                        <div class="form-group col-6 flex-column d-flex"> <label class="form-control-label px-3">Course Name<span class="text-danger"> *</span></label> 
                        <form:input path= "courseName" type="text" value="${courseName}" readonly="true"  /> </div>
