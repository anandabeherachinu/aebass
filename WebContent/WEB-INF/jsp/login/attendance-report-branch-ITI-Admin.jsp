...
<!--                 </div>
 -->               </div>
 			...
 			<div class="box col-md-12">
 				...
 				<form:form class="form-horizontal" action="attendance-report-branch-ITI-Admin.html" method="post"  modelAttribute="cb"
				...
				<table class="table_form">
 					...
 					<tr>
						...
						<td>
							 <form:select path="instituteCode" class="courese-sector" required="true" id="instituteCodeajax" >
						...
						<td>
							 <form:select path="courseName" class="courese-sector" required="true" id="branchAjax">
					      			<form:option value="">Select</form:option>
						...
						<td>
							 <form:select path="month" class="courese-sector" required="true" id="monthAjax">
					      			<form:option value="">Select</form:option>
...
<script type="text/javascript" src="js/report-admin-institute-branch-month.js"></script>
