...
<%--   <div class="panel-heading">
 			...
 			<div class="box col-md-12">
				...
				<table class="table_form">
 						<th colspan="2">Institute Type</th>
		...
		<c:otherwise>
 			...
 			<c:when test="${sessionScope.role_id eq '1' }">
				...
				<input class="btn btn-primary btn-font-size " type="submit" id="print_id" value="PRINT" onclick="myApp.printTable()"/>	 
 				...
 				<h4>Display Number of Students</h4>
				...
				<thead>
					...
					<tbody>
						...
						<c:forEach var="s" items="${collegelist}" varStatus="count">
							<tr>
									<td>${count.index+1}</td>
				<td class="top-buffer">${s.instituteCode}</td>  
<%-- 				<td class="top-buffer">${s.instituteName}</td> 
 --%>   	<td><a href="view-institute-semesterwise-count.html?institutecode=${s.instituteCode}"  >${s.instituteName} </a></td>
