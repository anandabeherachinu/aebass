...
// Pie Chart
var table3 = document.getElementById("data-table3");
for (var i = 0; i < table3.rows.length; i++) {
    var cell3 = table3.rows[i].cells[0];
    var cell5 = table3.rows[i].cells[1];
    var present = cell3.innerText;
    var presentPercentage = cell5.innerText;
    var presentPercentage1 = parseFloat(cell5.innerText).toFixed(2);

    
}
console.log("present1: " + present);
console.log("presentPercentage1: " + presentPercentage1);
var table4 = document.getElementById("data-table4");
for (var i = 0; i < table4.rows.length; i++) {
    var cell4 = table4.rows[i].cells[0];
    var absent = cell4.innerText;
    var cell6 = table4.rows[i].cells[1];
    var absentPercentage = cell6.innerText;
    var absentPercentage1 = parseFloat(cell6.innerText).toFixed(2);

    
}
console.log("absent1: " + absent);
...
if(ctx23) {
	var myChart23 = new Chart(ctx23, {
	    ...
	    data: {
	    	...
	    	labels: [ 'present Percentage','absent Percentage'],
	        datasets: [{
	            label: 'Pie',
	            //data: [present,presentPercentage,absent,absentPercentage],
	            data: [presentPercentage1,absentPercentage1],
	            backgroundColor: [
